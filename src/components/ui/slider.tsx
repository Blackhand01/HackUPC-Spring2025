...
const Slider = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof SliderPrimitive.Root> & { trackClassName?: string; thumbClassName?: string; rangeClassName?: string }
>(({ className, trackClassName, thumbClassName, rangeClassName, ...props }, ref) => (
  ...
  >
    ...
    {/* Allow multiple thumbs by checking the value prop */}
